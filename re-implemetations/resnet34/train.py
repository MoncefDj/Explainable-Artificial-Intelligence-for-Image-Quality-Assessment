...
# Model
# ---------------------------------------------------------------
# NOTE: This ResNet-34 is initialized with ImageNet-pretrained weights
...
output_dir = "." # Save in the current directory (resnet34/)
...
for epoch in range(1, num_epochs + 1):
    ...
    if val_acc > best_val_acc:
        ...
        # Original name format: f"resnet34/{best_val_acc}best_resnet34_object_cxr.pth"
        # Saving locally:
        model_save_path = os.path.join(output_dir, f"{best_val_acc:.4f}_best_resnet34_object_cxr.pth") # Using .4f for consistency
